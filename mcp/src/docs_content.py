...
This module contains the complete PM system documentation as a string constant.
"""

DOCS_CONTENT = """# LLM-Native Project Management System - Complete Documentation
